...
const Testimonials = () => (
  ...
  >
    ...
    <div
      className={`w-full flex justify-between md:flex-row flex-col sm:mb-16 mb-6 relative z-[1] ${styles.paddingX} ${styles.flexCenter}`}
    >
    ...
    <div
      className={`flex flex-wrap sm:justify-start justify-center w-full feedback-container relative z-[1] ${styles.paddingX}`}
    >
